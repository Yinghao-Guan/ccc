export default function Events() {
  return (
    <section id="events" data-screen-label="03 Events">
      <div className="wrap">
        ...
        <article className="events-feature in">
          <div className="events-feature__img">
            <span className="stripes" aria-hidden="true" style={{ fontSize: '17px', fontWeight: 400 }}></span>
          ...
          <div className="events-feature__body">
            ...
            <h3 className="events-feature__title"><span className="it">Lunar New Year</span><br />Gala &amp; Banquet.</h3>
            <p className="events-feature__cn">农 历 新 年 · 春 节 晚 会</p>
            <p className="events-feature__copy">An evening of dumplings folded by hand, lion dance from our friends at the Wushu Society, calligraphic couplets you take home, and a long table where two hundred people sit shoulder to shoulder.</p>
            ...
            <a className="btn-ghost" href="#join">Reserve a seat <span className="arrow"></span></a>
          </div>
        </article>
        ...
        <div className="events-list in">
          <a className="event" href="#join">
            ...
            <div className="event__meta">
              <span className="label">Where</span>The Quad — under the southern oaks. Tea, lanterns, and slices of mooncake cut for everyone.
            </div>
            <div className="event__meta">
          ...
          <a className="event" href="#join">
            ...
            <div className="event__meta">
              <span className="label">Where</span>HSS 151, with brushes provided. A guided introduction to 楷书 with Prof. L. Li.
            </div>
            <div className="event__meta">
          ...
          <a className="event" href="#join">
            ...
            <div className="event__meta">
              <span className="label">Where</span>Westfield Century City · Haidilao. Bring an empty bowl — we&apos;ll bring the broth.
            </div>
            <div className="event__meta">
          ...
          <a className="event" href="#join">
            ...
            <div className="event__meta">
              <span className="label">Where</span>The Library, lower ground floor. Milk oolong, white peony, and a single bowl of silence.
            </div>
            <div className="event__meta">
          ...
          <a className="event" href="#join">
            ...
            <div>
              <h4 className="event__title">Winter <em>Film Screening</em> — <em>In the Mood for Love</em></h4>
