        ...
        <div className="about-grid">
          <div className="about__body in">
            <p className="about__lead">
              The Chinese Culture Club is a place where students of every background gather to taste,
              to make, to ask, and to share what their families once knew — or what they have always
              wanted to know.
            </p>
            <p>
